...
# ==========================================因子检测参数设置==============================================================
    start_date = '2026-08-16'  # 回测开始时间
    end_date = '2026-09-15'  # 回测结束时间
    ...
    def sfactor_data(self, start_date, end_date, stocks, names):
        return get_sfactor_data(start_date, end_date, stocks, names)
    ...
    def calc(self):
        ...
        mak_value = get_sfactor_data(self.start_date, self.end_date, self.stocks, ["current_market_cap"])["current_market_cap"]
        ...
        # ==========================================合成因子数据处理=========================================================
        # 缺失值填充
        factors = self.fillnan_data(factors, self.dataprcess["fillna"], industry_data, mak_value)
        # 极值处理
