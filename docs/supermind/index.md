...
const home = {
  ...
  actions: [
    { text: '快速开始', link: '/supermind/guide/other/yi-qian-yan', kind: 'primary' },
    { text: 'API 文档', link: '/supermind/reference/api/zhong-yao-xie-zai-zui-qian-mian', kind: 'secondary' },
    { text: '常见问题', link: '/supermind/guide/faq/guan-yu-supermind', kind: 'secondary' },
  ],
  highlights: [
    {
      title: '策略 API',
