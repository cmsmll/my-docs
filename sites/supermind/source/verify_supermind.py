...
用法：python verify_supermind.py <dist 目录>
"""
...
def main(dist_dir: Path):
    docs = C.load_docs(C.fetch(Path(__file__).resolve().parent))
    ...
    md_root = dist_dir.parents[1]          # <docs>/.vitepress/dist -> <docs>
